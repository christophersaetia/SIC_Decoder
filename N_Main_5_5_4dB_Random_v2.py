...
plt.close('all')
print('\nUser 0 Analysis --------')
u0_file = '../Oscope_Recordings/5_5_2026/4dB/Random/NOMA_Test_1MHz_40mV_3ms__u0a0_1.csv'
...
plt.close('all')
print('\nUser 1 Analysis --------')
u1_file = '../Oscope_Recordings/5_5_2026/4dB/Random/NOMA_Test_1MHz_40mV_3ms__u1a0_1.csv'
...
SI_file = '../Oscope_Recordings/5_5_2026/4dB/Random/NOMA_Test_1MHz_40mV_3ms__SIa0__2_users_only_1.csv'
...
SI_Pilots_Analysis = utils.SIC_Pilots_Checker(SI_input_vals = -1 * SI_Adjusted.baseline_adjusted_seq, 
                                              ...
                                              template_comparision= SI_template_pilot_comparision_waveform,
                                              u0_guess_attempts_arr = [0.05], 
                                              start_align_idx_arr = [int(350.1e3), int(714.8e3)], 
...
SI_Decoder = utils.SIC_Decoder(SI_input_vals = SI_Adjusted.baseline_adjusted_seq, 
                               sps = SI_decoder_sps, 
                               num_users = 2, 
                               users_channel_coeffs_arr = [-0.05, -.02],
                               thresh_y_vals_arr= [-0.01, -0.04],
                               template_comparision= SI_template_pilot_comparision_waveform,
                               start_align_idx_arr = [int(350.1e3), int(714.8e3)], 
                               samples_search_amount = int(5e3), 
                               detect_bound_index_shift_arr = [0, 0],
                               plot_flag = True, 
                               speed_plot_flag = True)
