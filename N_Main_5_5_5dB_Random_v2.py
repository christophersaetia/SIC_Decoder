...
plt.close('all')
print('\nUser 0 Analysis --------')
u0_file = '../Oscope_Recordings/5_5_2026/5dB/Random/NOMA_Test_1MHz_40mV_3ms__u0a0_1.csv'
...
plt.close('all')
print('\nUser 1 Analysis --------')
u1_file = '../Oscope_Recordings/5_5_2026/5dB/Random/NOMA_Test_1MHz_40mV_3ms__u1a0_1.csv'
...
SI_file = '../Oscope_Recordings/5_5_2026/5dB/Random/NOMA_Test_1MHz_40mV_3ms__SIa0__2_users_only_1.csv'
...
SI_Pilots_Analysis = utils.SIC_Pilots_Checker(SI_input_vals = -1 * SI_Adjusted.baseline_adjusted_seq, 
                                              ...
                                              start_align_idx_arr = [int(331e3), int(659e3)], 
...
SI_Decoder = utils.SIC_Decoder(SI_input_vals = SI_Adjusted.baseline_adjusted_seq, 
                               sps = SI_decoder_sps, 
                               num_users = 2, 
                               users_channel_coeffs_arr = [-0.0715, -.02],
