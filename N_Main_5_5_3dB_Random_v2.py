...
plt.close('all')
print('\nUser 0 Analysis --------')
u0_file = '../Oscope_Recordings/5_5_2026/3dB/Random/NOMA_Test_1MHz_40mV_3ms__u0a0_1.csv'
...
plt.close('all')
print('\nUser 1 Analysis --------')
u1_file = '../Oscope_Recordings/5_5_2026/3dB/Random/NOMA_Test_1MHz_40mV_3ms__u1a0_1.csv'
...
SI_file = '../Oscope_Recordings/5_5_2026/3dB/Random/NOMA_Test_1MHz_40mV_3ms__SIa0__2_users_only_1.csv'
...
SI_Pilots_Analysis = utils.SIC_Pilots_Checker(SI_input_vals = -1 * SI_Adjusted.baseline_adjusted_seq, 
                                              ...
                                              start_align_idx_arr = [int(327e3), int(925.5e3)], 
...
SI_Decoder = utils.SIC_Decoder(SI_input_vals = SI_Adjusted.baseline_adjusted_seq, 
                               sps = SI_decoder_sps, 
                               num_users = 2, 
                               users_channel_coeffs_arr = [-0.0625, -.06],
                               thresh_y_vals_arr= [-0.00409, -0.025],
                               template_comparision= SI_template_pilot_comparision_waveform,
                               start_align_idx_arr = [int(327e3), int(517e3)], 
                               samples_search_amount = int(5e3), 
                               detect_bound_index_shift_arr = [-1, 10],
                               plot_flag = True, 
                               speed_plot_flag = True)
